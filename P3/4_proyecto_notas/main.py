    ...
    while opcion:
        ...
        if opcion=="1" or opcion=="REGISTRO":
            ...
            if regresar:
                ...
                print("Por favor intentalo denuevo... no fue posible realizar el registro en este momento ...")
            ...
            password=input("\t Ingresa tu contraseña: ").strip()
            #Agregar codigo 
            lista_usuario=usuario.iniciar_secion(email,password)
            if lista_usuario:
                menu_notas(19,"Dago","Fiscal")
            else:
                print(f"... El e-mail y/o contraseña no considen .... intentelo denuevo")
                funciones.borrarPantalla()
