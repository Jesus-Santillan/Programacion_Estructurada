    ...
    try:
        ...
        match opc_materia:
            case 1:
                ...
                abrir_archivo("PF\conf_sistema.py")
            case 2:
                print(f"   \t\t",f"".center(25,'-'),"⁙",f" Gestionar datos ".center(23,' '),"⁙",f"".center(25,'-'),f"\t\t\t   ")
                print("\n")
                abrir_archivo("PF\conf_datos.py")
            case 3:
                pausa_borra('b')
                print(" ⁖ Extra ⁖ ")
                print("Santillan Fuentes Jesus Emilio")
                print("Castillo Díaz Humberto")
                print("A base de prueba y error... es que la humanidad seguira avanzando")
